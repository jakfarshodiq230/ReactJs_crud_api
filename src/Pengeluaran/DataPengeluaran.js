...
export class DataPengeluaran extends Component {
    ...
    deleteDep(depid) {
        if (window.confirm('Apakah Anda Yakin Hapus Data ' + depid)) {
            axios.delete(api + '/c_resetapi_pengeluaran/' + depid)
    ...
    EditDep(id) {
        if (window.confirm('Apakah Anda Ingin Mengedit Data ' + id)) {
            this.props.history.push('/Pengeluaran_edit/'+id);
        }
    }

    //edit data
    LihatDep(id) {
            this.props.history.push('/Pengeluaran_show/'+id);
    }
    render() {
        return (
            <div className="container-fluid">
                <div className="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 className="h3 mb-0 text-gray-800">Data Pengeluaran</h1>
                    ...
                    <div className="col-xl-12 col-md-2 mb-2">
                        <div className="card shadow mb-4">
                            <div className="card-header py-3">
                                <h6 className="m-0 font-weight-bold text-primary text-left" >List Data Pengeluaran</h6>
                            </div>
                            <div className="card-body">
                                <div className="table-responsive">
                                    <div className="d-sm-flex align-items-center justify-content-between mb-4">
                                        <Link to="/Pengeluaran_tambah" className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i className="fas fa-pencil fa-sm text-white-50"></i>Tambah Data</Link>
                                    </div>
